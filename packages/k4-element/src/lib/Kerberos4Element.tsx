...
const DEFAULT_HL: [number, number][] = [
  [0, 1],
  [2, 3],
];
...
export function Kerberos4Element({
  ...
  const faces = useMemo(() => {
    const TRI_FACES: [number, number, number][] = [
      [0, 2, 1],
      [0, 1, 3],
      [0, 2, 3],
      [1, 2, 3],
  ...
  const statusColor = (s: string) =>
    s === 'ACTIVE' ? '#34d399' : s === 'DEGRADED' ? '#fbbf24' : '#ff6058';
  ...
  return (
    ...
    >
      ...
      {edges.map((e) => {
        ...
        const isHL = highlightEdges.some(

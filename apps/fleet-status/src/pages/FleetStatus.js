    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx('div', {
          ...
          children: _jsxs('div', {
            children: [
              _jsx('h1', { className: styles.title, children: '\u0394 FLEET STATUS' }),
              _jsxs('p', {
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [activeCount, '/', FLEET_DATA.length],
                }),
                _jsx('div', { className: styles.kpiLabel, children: 'UNITS ONLINE' }),
              ],
            }),
            _jsxs('div', {
              className: styles.kpiCard,
              children: [
                _jsx('div', { className: styles.kpiValue, children: '2,847' }),
                _jsx('div', { className: styles.kpiLabel, children: 'TOTAL BONDS' }),
              ],
            }),
            _jsxs('div', {
              className: styles.kpiCard,
              children: [
                _jsx('div', { className: styles.kpiValue, children: '312' }),
                _jsx('div', { className: styles.kpiLabel, children: 'PSI MSG/MIN' }),
              ],
            }),
            _jsxs('div', {
              className: styles.kpiCard,
              children: [
                _jsx('div', { className: styles.kpiValue, children: '1.2s' }),
                _jsx('div', { className: styles.kpiLabel, children: 'RESPONSE LAT' }),
              ],
            }),
          ],
        }),
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('span', { className: `${styles.dot} ${styles.dotRed}` }),
                _jsx('span', { className: `${styles.dot} ${styles.dotYellow}` }),
                _jsx('span', { className: `${styles.dot} ${styles.dotGreen}` }),
                _jsx('span', {
                  className: styles.terminalTitle,
                  children: 'meatspace@k4-fleet:~$',
                }),
              ],
            }),
            _jsxs('div', {
              ...
              children: [
                history.map((cmd, i) =>
                  _jsxs(
                    ...
                    {
                      children: [
                        _jsxs('div', { className: styles.userInput, children: ['$ ', cmd.input] }),
                        _jsx('div', {
                          className: cmd.type === 'error' ? styles.stderr : styles.stdout,
                          children: cmd.output
                            .split('\n')
                            .map((line, j) => _jsx('div', { children: line || '\u00A0' }, j)),
                        }),
                      ],
                    },
                    i,
                ...
                history.length === 0 &&
                  _jsx('div', {
                    ...
                    children: 'Initializing fleet monitor...',
                  }),
                _jsx('form', {
                  onSubmit: handleSubmit,
                  children: _jsxs('div', {
                    className: styles.prompt,
                    children: ['$ ', input, _jsx('span', { className: styles.cursor })],
                  }),
                }),
              ],
            }),

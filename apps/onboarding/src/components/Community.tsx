      ...
      <div>
        ...
        <div className="community-grid">
          ...
          >
            ...
            <span className="community-link">github.com/anomalyco/bonding →</span>
          </a>

          <div className="community-card community-card--soon">
            <div className="community-icon">
              <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
            ...
            <h3>Discord</h3>
            <p>Chat with the community, ask questions, share pilots, and find your lab partners.</p>
            <span className="community-link-ghost">Coming Soon</span>
          </div>

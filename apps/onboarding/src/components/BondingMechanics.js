...
const ENERGY_ZONES = [
  {
    range: '< 30%',
    zone: 'Calm 🌿',
    desc: 'Low energy — rest, reflect, be present without pressure',
  },
...
export function BondingMechanics() {
  return _jsx('section', {
    ...
    children: _jsxs('div', {
      children: [
        _jsx('div', { className: 'section-label', children: 'Relationship Types' }),
        _jsx('h2', { children: 'Bonding Mechanics' }),
        _jsx('p', {
          className: 'lead',
          children:
            'Bonds track real co-presence \u2014 not likes, not messages. Every check-in with a bonded atom deepens the connection.',
        }),
        _jsx('div', {
          className: 'bond-types',
          children: BOND_TYPES.map((bt) =>
            _jsxs(
              'div',
              {
                className: 'bond-type',
                children: [
                  _jsx('h3', { children: bt.title }),
                  _jsx('p', { children: bt.desc }),
                  _jsx('span', {
                    className: 'tag',
                    style: { background: bt.tagColor + '20', color: bt.tagColor },
                    children: bt.tag,
                  }),
                ],
              },
        ...
        _jsxs('div', {
          style: { marginTop: 60 },
          children: [
            _jsx('div', { className: 'section-label', children: 'Energy-Aware Zones' }),
            _jsx('h3', {
              style: { fontSize: 22, fontWeight: 700, marginBottom: 12 },
              children: '\uD83C\uDF3F Your Energy Matches the Zone',
            }),
            _jsx('p', {
              className: 'lead',
              style: { marginBottom: 32 },
              children:
                'BONDING reads PHOS health data (on-device only) to suggest the best zone for your current capacity. No data leaves your device unless you opt in.',
            }),
            _jsx('div', {
              style: {
                display: 'grid',

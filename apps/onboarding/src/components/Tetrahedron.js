      ...
      children: [
        _jsx('defs', {
          children: _jsx('filter', {
            ...
            width: '200%',
            height: '200%',
            children: _jsx('feGaussianBlur', { stdDeviation: '0.02', result: 'blur' }),
          }),
        }),
        _jsxs('g', {
          filter: 'url(#tetraBlur)',
          children: [
            edges.map(([a, b], idx) => {
              ...
              return _jsx(
                'line',
                { x1: pa.x, y1: pa.y, x2: pb.x, y2: pb.y, className: styles.edgeLine },
                idx,
              );
            }),
            projected.map((p, i) => {

...
export function GetStarted() {
    return (_jsx("section", { id: "start", children: _jsxs("div", { children: [_jsx("div", { className: "section-label", children: "Launch Your Pilot" }), _jsx("h2", { children: "Get Started in 8 Steps" }), _jsx("p", { className: "lead", style: { margin: '0 auto' }, children: "BONDING is designed for hyperlocal pilots. Everything you need to run one in your neighborhood is in the repo." }), _jsx("div", { className: "start-steps", children: START_STEPS.map((s, i) => (_jsx("div", { className: "start-step", children: _jsxs("div", { children: [_jsx("h3", { children: s.title }), _jsx("p", { children: s.desc })] }) }, i))) }), _jsx("div", { className: "start-cta", children: _jsx("a", { href: "https://github.com/anomalyco/bonding", className: "btn btn-primary", target: "_blank", rel: "noopener noreferrer", children: "View on GitHub \u2192" }) })] }) }));
}

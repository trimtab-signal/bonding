...
export function LiveDemo() {
  return _jsx('section', {
    ...
    children: _jsxs('div', {
      children: [
        _jsx('div', { className: 'section-label', children: 'Live Demo' }),
        _jsx('h2', { children: 'See the Molecule in Motion' }),
        _jsx('p', {
          className: 'lead',
          children:
            'Atoms orbiting, bonds forming, zones lighting up. This is BONDING \u2014 your neighborhood as a living molecule.',
        }),
        _jsxs('div', {
          className: 'demo-container',
          children: [
            _jsxs('div', {
              className: 'demo-molecule',
              children: [
                _jsx('div', {
                  className: 'demo-nucleus',
                  children: _jsx('span', { children: 'BOND' }),
                }),
                PARTICLES.map((p) =>
                  _jsx(
                    'div',
                    {
                      ...
                      children: _jsx('div', {
                        ...
                        children: _jsx('span', { children: p.label }),
                      }),
                    },
                    p.label,
                  ),

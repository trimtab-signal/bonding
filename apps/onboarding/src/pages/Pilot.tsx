      ...
      <section className={styles.section}>
        <div className={styles.inner}>
          ...
          <p className={styles.desc}>
            We're running hyperlocal pilots in <strong>Kingsland/St. Marys, GA</strong>. Sign up
            below and we'll send you everything you need to get started.
          </p>
          ...
          {submitted ? (
            <Card variant="elevated" className={styles.success}>
              ...
              <p>
                We'll reach out at <strong>{email}</strong> with next steps. In the meantime, try
                the demo:
              </p>
              <a href="#/demo" className={styles.demoLink}>
                🧪 Try the Living Molecule Demo →
              </a>
            </Card>
          ) : (

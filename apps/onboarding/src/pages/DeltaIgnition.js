...
export function DeltaIgnition() {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        className: `${styles.bg} ${phase === 'wye' ? styles.bgWye : phase === 'implosion' ? styles.bgImplosion : phase === 'stride' || phase === 'delta' ? styles.bgDelta : phase === 'intro' ? styles.bgComplete : ''}`,
      }),
                      ...
                      children: [
                        _jsx('defs', {
                          children: _jsx('filter', {
                            ...
                            width: '200%',
                            height: '200%',
                            children: _jsx('feGaussianBlur', { stdDeviation: '6' }),
                          }),
                        }),
                        _jsx('circle', {
                          cx: '0',
          ...
          phase === 'implosion' &&
            _jsx(
              motion.div,
              {
                ...
                children: _jsx('div', { className: styles.implosionCore }),
              },
              'implosion',
            ),
          phase === 'delta' &&
            _jsxs(
              motion.div,
              {
                ...
                children: [
                  _jsx('div', {
                    className: styles.deltaTetraWrap,
                    children: _jsx('div', {
                      className: styles.tetrahedronInner,
                      children: _jsx(Tetrahedron, {
          ...
          phase === 'stride' &&
            _jsxs(
              motion.div,
              {
                ...
                className: `${styles.layer} ${styles.layerInteractive}`,
                children: [
                  _jsx('div', { className: styles.glare }),
                  _jsxs('div', {
                    className: styles.strideWrap,
                    children: [
                      _jsx('div', { className: styles.strideDeltaSymbol, children: '\u0394' }),
                      _jsx('div', { className: styles.strideTitle, children: labels.main }),
                      labels.sub &&
                        _jsx('div', { className: styles.strideSubtitle, children: labels.sub }),
                      _jsx('button', {
                        className: styles.enterBtn,
                        onClick: () => navigate('/trim-tabs'),
                        children: 'ENTER THE DELTA',
                      }),
                    ],
                  }),
                ],

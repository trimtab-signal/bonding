    ...
    <section className={styles.section}>
      <div className={styles.inner}>
        ...
        <p className={styles.desc}>
          All assets are open source and free to use. Attribution appreciated but not required. For
          press inquiries: <a href="mailto:pilot@bonding.p31ca.org">pilot@bonding.p31ca.org</a>
        </p>
        ...
        <div className={styles.grid}>
          {ASSETS.map((a) => (
            <Card key={a.file} variant="elevated" className={styles.asset}>
              <h3>{a.name}</h3>
              <p>{a.desc}</p>
              <a href={`/media/${a.file}`} download className={styles.downloadBtn}>
                Download
              </a>
            </Card>
          ))}

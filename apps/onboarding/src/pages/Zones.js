  ...
  _jsx(Layout, {
    children: _jsx('section', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('span', { className: styles.label, children: 'The Five Zones' }),
          _jsx('h2', { className: styles.title, children: 'Choose Your Space' }),
          _jsx('p', {
            ...
            children: ZONES.map((z) =>
              _jsxs(
                Card,
                {
                  ...
                  children: [
                    _jsx('span', { className: styles.emoji, children: z.emoji }),
                    _jsx('h3', { children: z.name }),
                    _jsx('p', { children: z.desc }),
                    _jsxs('span', { className: styles.radius, children: [z.radius, ' radius'] }),
                  ],
                },
                z.id,
              ),

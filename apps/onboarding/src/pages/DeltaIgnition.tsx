...
export function DeltaIgnition() {
  ...
  return (
    <div className={styles.container}>
      <div className={`${styles.bg} ${phase === 'wye' ? styles.bgWye : phase === 'implosion' ? styles.bgImplosion : phase === 'stride' || phase === 'delta' ? styles.bgDelta : phase === 'intro' ? styles.bgComplete : ''}`} />
      ...
      <button className={styles.skipBtn} onClick={() => navigate('/trim-tabs')}>
        Skip ›
      </button>

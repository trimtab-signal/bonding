      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('h2', { className: styles.title, children: '\uD83E\uDDEA The Living Molecule' }),
              _jsxs('p', {
                className: styles.desc,
                children: [
                  'Atoms drift, bond, and react. ',
                  _jsx('strong', { children: 'Click' }),
                  ' to add, ',
                  _jsx('strong', { children: 'drag' }),
                  ' to bond. Switch zones to change the vibe.',
                ],
              }),
              tutorialStep === -1 &&
                _jsx('button', {
                  ...
                  children: _jsxs('div', {
                    ...
                    children: [
                      _jsxs('div', {
                        ...
                        children: [
                          _jsxs('span', {
                            className: styles.tooltipStep,
                            children: ['Step ', tutorialStep + 1, ' of ', totalSteps],
                          }),
                          _jsx('button', {
                      ...
                      _jsx('h3', { className: styles.tooltipTitle, children: step.title }),
                      _jsx('p', { className: styles.tooltipText, children: step.text }),
                      step.action &&
                        _jsx('div', { className: styles.tooltipAction, children: step.action }),

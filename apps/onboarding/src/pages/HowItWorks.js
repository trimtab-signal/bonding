  ...
  _jsx(Layout, {
    children: _jsx('section', {
      ...
      children: _jsxs('div', {
        ...
        children: [
          _jsx('span', { className: styles.label, children: 'The Game Loop' }),
          _jsx('h2', { className: styles.title, children: 'How BONDING Works' }),
          _jsx('p', {
            className: styles.desc,
            children:
              'No profiles to swipe. No DMs. No algorithms. You show up at a real place, and the game handles the rest.',
          }),
          _jsx('div', {
            ...
            children: STEPS.map((step, i) =>
              _jsxs(
                Card,
                {
                  ...
                  children: [
                    _jsx('span', { className: styles.stepNumber, children: i + 1 }),
                    _jsx('span', { className: styles.stepEmoji, children: step.emoji }),
